---
title: "Introduction"
subtitle: "Black Ochre Data Labs"
date: "2023-02-16"
output: 
...
- R User for ~20 years
- Short training course with Hadley Wickham (2015)
- Senior Author of 3 R Packages 
    + `ngsReports`, `strandChckR`, `extraChIPs`
...
- Used by political parties (e.g. Trump, Biden), Google, ATO etc
- ABS wanted my R skills specifically
